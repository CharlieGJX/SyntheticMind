...
Explore powerful command-line functionalities with Vibe-AI's CMD mode.

![vibe-ai-cmd](https://github.com/user-attachments/assets/6c58c549-1564-43cf-b772-e1c9fe91d19c)
...
![vibe-ai-repl](https://github.com/user-attachments/assets/218fab08-cdae-4c3b-bcf8-39b6651f1362)

### Shell Assistant

Elevate your command-line efficiency. Describe your tasks in natural language, and let Vibe-AI transform them into precise shell commands. Vibe-AI intelligently adjusts to your OS and shell environment.

![vibe-ai-execute](https://github.com/user-attachments/assets/0c77e901-0da2-4151-aefc-a2af96bbb004)
...
| ----------------- | ------------------------------------ | -------------------------------- |
| CMD               | `vibe-ai hello`                       |                                  |
| STDIN             | `cat data.txt \| vibe-ai`             |                                  |
| Last Reply        |                                      | `.file %%`                       |
| Local files       | `vibe-ai -f image.png -f data.txt`    | `.file image.png data.txt`       |
| Local directories | `vibe-ai -f dir/`                     | `.file dir/`                     |
| Remote URLs       | `vibe-ai -f https://example.com`      | `.file https://example.com`      |
| External commands | ```vibe-ai -f '`git diff`'```         | ```.file `git diff` ```          |
| Combine Inputs    | `vibe-ai -f dir/ -f data.txt explain` | `.file dir/ data.txt -- explain` |

### Role

Customize roles to tailor LLM behavior, enhancing interaction efficiency and boosting productivity.

![vibe-ai-role](https://github.com/user-attachments/assets/023df6d2-409c-40bd-ac93-4174fd72f030)
...
![vibe-ai-session](https://github.com/user-attachments/assets/56583566-0f43-435f-95b3-730ae55df031)
...
![vibe-ai-macro](https://github.com/user-attachments/assets/23c2a08f-5bd7-4bf3-817c-c484aa74a651)

### RAG

Integrate external documents into your LLM conversations for more accurate and contextually relevant responses.

![vibe-ai-rag](https://github.com/user-attachments/assets/359f0cb8-ee37-432f-a89f-96a2ebab01f6)
...
![vibe-ai-agent](https://github.com/user-attachments/assets/0b7e687d-e642-4e8a-b1c1-d2d9b2da2b6b)

### Local Server Capabilities

Vibe-AI includes a lightweight built-in HTTP server for easy deployment.
...
![vibe-ai-llm-playground](https://github.com/user-attachments/assets/aab1e124-1274-4452-b703-ef15cda55439)

#### LLM Arena

A web platform to compare different LLMs side-by-side.

![vibe-ai-llm-arena](https://github.com/user-attachments/assets/edabba53-a1ef-4817-9153-38542ffbfec6)
